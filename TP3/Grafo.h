...
public:
    ...
    Grafo();
    //PRE: -
    //POST: Conecta todos los vertices del grafo usando la funcion agregarCamino.
    void conectar_vertices(int vertice);
    CaminoMinimo* obtenerCaminoMinimo();
    ...
    void agregarCamino(int terreno, string origen, string destino);
    ...
    int costoViaje(int origen, int destino);

    int ** obtenerMatrizCaminos();
